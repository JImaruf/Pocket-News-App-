...
public class EntertainmentFragment extends Fragment {
    ...
    private RecyclerView entertainmentRecyler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        entertainmentRecyler=v.findViewById(R.id.entertainmentRecyclerView);
        list= new ArrayList<>();
        entertainmentRecyler.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getContext(),list);
        entertainmentRecyler.setAdapter(adapter);
